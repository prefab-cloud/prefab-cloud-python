...
class TestSemanticVersion:
    VersionTestCase = namedtuple(
        "VersionTestCase",
        ["description", "input", "expected_result"]
    )

    ComparisonTestCase = namedtuple(
        "ComparisonTestCase",
        ["description", "version1", "version2", "expected_result"]
    )
    ...
    @pytest.mark.parametrize("case", [
        VersionTestCase(
            ...
            "1.2.3",
            {"major": 1, "minor": 2, "patch": 3, "prerelease": "", "build_metadata": ""}
        ),
        VersionTestCase(
            "version with prerelease parse succeeds",
            "1.2.3-alpha.1",
            {"major": 1, "minor": 2, "patch": 3, "prerelease": "alpha.1", "build_metadata": ""}
        ),
        VersionTestCase(
            "version with build metadata parse succeeds",
            "1.2.3+build.123",
            {"major": 1, "minor": 2, "patch": 3, "prerelease": "", "build_metadata": "build.123"}
        ),
        VersionTestCase(
    ...
    @pytest.mark.parametrize("case", [
        ...
        VersionTestCase("invalid build metadata format returns None", "1.2.3+", None),
    ], ids=lambda c: c.description)
    ...
    @pytest.mark.parametrize("case", [
        ...
        ComparisonTestCase(
            "higher major version compares greater",
            "2.0.0",
            "1.2.3",
            1
        ),
        ComparisonTestCase(
            "lower major version compares less",
            "1.2.3",
            "2.0.0",
            -1
        ),
        ComparisonTestCase(
            "higher minor version compares greater",
            "1.3.0",
            "1.2.3",
            1
        ),
        ComparisonTestCase(
            "higher patch version compares greater",
            "1.2.4",
            "1.2.3",
            1
        ),
        ...
        ComparisonTestCase(
            "prerelease ordering is correct",
            "1.2.3-alpha.2",
            "1.2.3-alpha.1",
            1
        ),
        ComparisonTestCase(
            "alpha.1 comes before beta.1",
            "1.0.0-alpha.1",
            "1.0.0-beta.1",
            -1
        ),
